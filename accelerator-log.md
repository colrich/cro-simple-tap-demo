...
```json
{
  "projectName" : "cro-simple-tap-demo"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [tanzu-java-web-app->cro-simple-tap-demo]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [: tanzu-java-web-app->: cro-simple-tap-dem...(truncated)]
